...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "backoffice1_0" because\n';
  ...
  $wnd.__gwt_activeModules['backoffice1_0'] = {
    'moduleName' : 'backoffice1_0',
    'bindings' : function() {
      return {};
    }
  };
 ...
 * "/backoffice1_0.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['backoffice1_0'].superdevmode = true;

  var expectedSuffix = '/backoffice1_0.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + backoffice1_0 + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:backoffice1_0';
  var devModeSessionKey = '__gwtDevModeSession:backoffice1_0';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/backoffice1_0/backoffice1_0.nocache.js';
  ...
  $wnd.__gwt_activeModules['backoffice1_0'].canRedirect = true;
  $wnd.__gwt_activeModules['backoffice1_0'].superdevmode = true;
  ...
  css = (moduleIdx == 1 ? css : '') +
    ".gwt-DevModeModule-" + moduleIdx + ".gwt-DevModeCompiling div:before{" +
      "content:'COMPILING backoffice1_0';" +
      "font-size:24px;" +
      "color:#d2d9ee;" +
    "}";
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/backoffice1_0?user.agent=' + ua + '&_callback=' + callback;
